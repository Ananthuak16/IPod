...
class Wheel extends React.Component {
            ...
            <div className="wheel-container" id="wheel-container">
                <div style={{backgroundColor:wheelColor}} className="wheel" id="wheel" >
                    ...
                    <div className="controll" id="forward">
                        <i style={{color:theme}} className="fas fa-fast-forward"><FaForward /></i>
                    </div>
                    <div className="controll" id="play-pause">
                        <div>
                            <i style={{color:theme}} className="fas fa-play"><IoIosPlay /></i>
                            <i style={{color:theme}} className="fas fa-pause"><IoPause /></i>
                        </div>
                    </div>
                    <div className="controll" id="reverse">
                        <i style={{color:theme}} className="fas fa-fast-backward"><FaBackward /></i>
                    </div>
                </div>
    ...
    componentDidMount() {
        const { changeMenuBackward ,togglePlayPause, seekSongForward, seekSongReverse,setWheelColor } = this.props;
